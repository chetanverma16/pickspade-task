...
const Footer = ({ isPowerAmp, isFootController }: FooterProps) => {
  const [price, setPrice] = React.useState(1799);
  useEffect(() => {
    let price = 1799;
    if (isPowerAmp) {
      price += 449;
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex">
          <div className="flex items-start">
            <img className="mt-1" src="/icon1.png" alt="icon1" />
            <div className="ml-2">
              <h2 className="text-gray-900 text-lg">Free Shipping</h2>
              <p className="mt-2 text-gray-400 text-sm">
                Get 2-day free shipping anywhere <br /> in North America.
              </p>
            </div>
          </div>
          <div className="flex items-start ml-2">
            <img className="mt-1" src="/icon2.png" alt="icon1" />
            <div className="ml-2">
